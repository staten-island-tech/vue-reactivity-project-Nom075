...
export const buildings= ref([
  { name: 'Tongue', description: "A tongue to help you lick the cookie!", price: new Decimal(25), licksPerSecondBoost: new Decimal(1), image: "/Tongue.png", owned: 0,},
  { name: 'Cat', description: "Helps you lick the cookie. This one is immune to chocolate.", price: new Decimal(180), licksPerSecondBoost: new Decimal(5), image: "/Cat.png", owned: 0,},
    {name: 'Dog', description: "Slobbery Kisses for the cookie! Also immune to chocolate.", price: new Decimal(1000), licksPerSecondBoost: new Decimal(15), image: "/Dog.png", owned: 0,},
    {name: 'Licker-Bot', description: "It may not seem like it has a mouth but it is good at licking things.", price: new Decimal(6900), licksPerSecondBoost: new Decimal(55), image: "/Robot.webp", owned: 0,},
    {name: 'King Vaccum V', description: `Sucking is its middle name. Licking is for babies.`, price: new Decimal(45000), licksPerSecondBoost: new Decimal(350), image: "/Vaccum.png", owned: 0,},
])

export const upgrades= ref([
    {name: "Conversion I", price: new Decimal(30), description: "One day, you came along and saw a large cookie.", usefulDes: "Clicks gain 1% of licks per second.",  image: "/UPIC/Convert.png", unlocked: () => totalCookieMade.value.greaterThanOrEqualTo(30),  boost: () => LickPowerConversion.value = LickPowerConversion.value.plus(0.01)},
    {name: "Conversion II", price: new Decimal(1), description: "You licked and chewed, but you couldn't get rid of it.", usefulDes: "Clicks gain 1% of licks per second.", image: "/UPIC/Convert.png", unlocked: () => purchasedUpgrades.value.includes("Conversion I"),  boost: () => LickPowerConversion.value = LickPowerConversion.value.plus(0.01)},
    {name: "Conversion III", price: new Decimal(1), description: "You tried buying tongues to help lick, but it would not budge.", usefulDes: "Clicks gain 1% of licks per second.", image: "/UPIC/Convert.png", unlocked: () => purchasedUpgrades.value.includes("Conversion II"), boost: () => LickPowerConversion.value = LickPowerConversion.value.plus(0.01)},
    ...
    {name: "Saliva III", price: new Decimal(1), description: "Dripping faucet of saliva.", usefulDes: "Tongues are twice as efficient.", image: "/UPIC/WaterDrop.png", unlocked: () => buildings.value[0].owned >= 20 && purchasedUpgrades.value.includes("Saliva II"), boost: () => buildings.value[0].licksPerSecondBoost *= 2},
    {name: "Saliva IV", price: new Decimal(1), description: "Saliva factory.", usefulDes: "Tongues are twice as efficient.", image: "/UPIC/WaterDrop.png", unlocked: () => buildings.value[0].owned >= 35 && purchasedUpgrades.value.includes("Saliva III"), boost: () => buildings.value[0].licksPerSecondBoost *= 2},
    {name: "Saliva V", price: new Decimal(1), description: "Rename this building to Saliva already.", usefulDes: "Tongues are twice as efficient.", image: "/UPIC/WaterDrop.png", unlocked: () => buildings.value[0].owned >= 50 && purchasedUpgrades.value.includes("Saliva IV"), boost: () => buildings.value[0].licksPerSecondBoost *= 2},
    
    {name: "Kitty", price: new Decimal(1000), description: "A biggie that helps you eat your cookie.", usefulDes: "Cats are twice as efficient",  image: "/UPIC/WTFCat2.png", unlocked: () => buildings.value[1].owned >= 3,  boost: () => buildings.value[1].licksPerSecondBoost *= 2},
    {name: "Cat", price: new Decimal(1), description: "A big biggie that helps eat your cookie.", usefulDes: "Cats are twice as efficient", image: "/UPIC/WTFCat.png", unlocked: () => buildings.value[1].owned >= 10 && purchasedUpgrades.value.includes("Kitty"),  boost: () => buildings.value[1].licksPerSecondBoost *= 2},
    {name: "Gray Cat", price: new Decimal(1), description: "Biggest chocolate biggie.", usefulDes: "Cats are twice as efficient", image: "/UPIC/WTFCat3.png", unlocked: () => buildings.value[1].owned >= 20 && purchasedUpgrades.value.includes("Cat"), boost: () => buildings.value[1].licksPerSecondBoost *= 2},
    {name: "Insane Cat", price: new Decimal(1), description: "He looks funny.", usefulDes: "Cats are twice as efficient", image: "/UPIC/WTFCat4.png", unlocked: () => buildings.value[1].owned >= 35 && purchasedUpgrades.value.includes("Gray Cat"), boost: () => buildings.value[1].licksPerSecondBoost *= 2},
    {name: "Nyan Cat", price: new Decimal(1), description: "NYAN CATTTTTTTTT", usefulDes: "Cats are twice as efficient", image: "/UPIC/WTFCat5.png", unlocked: () => buildings.value[1].owned >= 50 && purchasedUpgrades.value.includes("Insane Cat"), boost: () => buildings.value[1].licksPerSecondBoost *= 2},
])

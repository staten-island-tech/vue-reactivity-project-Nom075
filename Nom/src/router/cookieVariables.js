...
//
    ...
    {name: "Software", price: new Decimal(10000), description: "More cookie studying!", usefulDes: "Licker-Bots are twice as efficient", image: "/UPIC/Bot3.png", unlocked: () => buildings.value[3].owned >= 20 && purchasedUpgrades.value.includes("Machinery"), boost: () => buildings.value[3].licksPerSecondBoost *= 2},
    {name: "AI", price: new Decimal(25000), description: "Strategizes together with the other bots.", usefulDes: "Licker-Bots are twice as efficient", image: "/UPIC/Bot4.png", unlocked: () => buildings.value[3].owned >= 30 && purchasedUpgrades.value.includes("Software"), boost: () => buildings.value[3].licksPerSecondBoost *= 2},
